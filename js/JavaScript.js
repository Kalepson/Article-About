...
const arr_text = ["Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever" +
...
arr_text.forEach(element => {
   let p_teg = document.createElement("p");
     p_teg.textContent = element;
    container.appendChild(p_teg)
})
